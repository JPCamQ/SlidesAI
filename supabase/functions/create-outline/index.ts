...
serve(async (req) => {
  ...
  try {
    ...
    const messages = [
      {
        role: 'system',
        content: `Eres un experto diseñador de presentaciones ejecutivas. Tu tarea es crear un outline detallado para una presentación profesional basándote en el análisis del contenido proporcionado.
