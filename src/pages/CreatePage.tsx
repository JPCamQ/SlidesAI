...
const CreatePage = () => {
  ...
  const handleSubmit = async () => {
    if (!transcript.trim()) {
      toast.error('Añade el contenido de la presentación');
      return;
    }
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <p className="animate-fade-in-up delay-200 text-body-lg text-muted-foreground max-w-2xl mx-auto mb-12">
            Transforma cualquier contenido en una presentación profesional con diapositivas visuales generadas por IA.
          </p>
          ...
          <div className="glass-card p-8 md:p-12 glow-border animate-scale-in">
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-title text-foreground">Contenido</h2>
                  <p className="text-sm text-muted-foreground">Sube un archivo o pega el texto base</p>
                </div>
              </div>
              ...
              <div className="relative">
                <Textarea
                  placeholder="O pega aquí el contenido para tu presentación..."
                  value={transcript}
