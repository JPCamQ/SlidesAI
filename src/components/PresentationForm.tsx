  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="glass-card">
        ...
        <CardContent>
          <Textarea
            placeholder="Ej: Enfócate en los puntos clave, resalta las ideas principales y propón conclusiones accionables..."
            value={userPrompt}
      ...
      <Card className="glass-card">
        <CardHeader className="pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-lg">Contenido de la Presentación</CardTitle>
              <CardDescription>Sube un archivo o pega el texto base directamente</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <Textarea
            placeholder="Pega aquí el contenido, artículo, transcripción o notas para tu presentación..."
            value={transcript}
